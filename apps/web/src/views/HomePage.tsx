                ...
                {g.items.map((n) => (
                  <NotificationRow
                    ...
                    onOpen={() => {
                      ...
                      } else if (n.entityType === "tax") {
                        navigate({ to: "/finance/tax" });
                      } else if (n.entityType === "contract") {
                        navigate({ to: "/crm/contracts/$contractId", params: { contractId: n.entityId } });
                      } else if (n.entityType === "invoice_schedule") {
                        navigate({ to: "/finance/recurring/$scheduleId", params: { scheduleId: n.entityId } });
...
function ApprovalCard({ n, approval }: { n: AppNotification; approval: ApprovalMeta }) {
  ...
  const kindLabel = approval.kind === "doc_review" ? "Doc review" : approval.kind === "milestone" ? "Milestone sign-off" : approval.kind === "leave" ? "Time off" : approval.kind === "expense" ? "Expense" : "Timesheet";
