 ...
 */
const KIND_LABEL: Record<ApprovalMeta["kind"], string> = { timesheet: "Timesheet", doc_review: "Doc review", milestone: "Milestone sign-off", leave: "Time off", expense: "Expense", invoice_review: "Invoice to send", invoice_issue: "Invoice to issue" };
